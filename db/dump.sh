pg_dump -U ob-analytics -d $1 -n bitfinex -s -T bitfinex.*00000*  > bitfinex_schema.sql
...
pg_dump -U ob-analytics -d $1 -t obanalytics.exchanges -a > obanalytics_exchanges.sql
