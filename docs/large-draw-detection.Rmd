...
If we try to locate spikes more precisely and choose the smaller duration of the period, the outcome worsens. Figure \@ref(fig:five-mins-spread-changes) shows all 5-minutes intervals in December during which BTCUSD the price changed has exceeded the same threshold of `r threshold`%. Note that there are few of them and there are no large spikes among them!
...
On figure \@ref(fig:large-drawup-decomposed) we decomposed the large upward spike shown in figure \@ref(fig:thrilling-up) above into twelve five-minutes periods. It is rather difficult to catch from those pictures the sheer size of the spike behind them.
