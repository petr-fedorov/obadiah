...
CalculateOrderBookSnapshots <- function(depth_changes, tick_size, ticks, debug_level) {
    .Call(`_obadiah_CalculateOrderBookSnapshots`, depth_changes, tick_size, ticks, debug_level)
}
